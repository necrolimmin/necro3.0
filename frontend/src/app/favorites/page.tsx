    ...
    <div className="min-h-screen bg-[#030712]">
      ...
      <main className="pt-24 pb-20 max-w-[1600px] mx-auto px-6 md:px-12">
        <motion.div className="mb-10" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <div className="section-kicker mb-3">Your favorites</div>
          ...
          <p className="text-white/50 mt-2">The titles you love most, ready when you are.</p>
        </motion.div>
        ...
        {isLoading ? (
          ...
          <div className="min-h-[45vh] flex items-center justify-center text-center">
            <div>
              ...
              <p className="text-white/45 max-w-sm">Tap the heart on any title to collect your favorites here.</p>
            </div>
          </div>
        )}
      </main>
